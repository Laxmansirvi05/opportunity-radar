      ...
      <section className="bg-surface-container-lowest border border-outline-variant/30 shadow-sm shadow-black/[0.02] rounded-[24px] p-6 flex flex-col md:flex-row items-center md:items-start justify-between gap-6 relative">
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start gap-8 w-full relative">
          ...
          <div className="relative group shrink-0">
            <div className="relative w-[120px] h-[120px] rounded-full bg-surface-variant text-on-surface-variant flex items-center justify-center font-display text-4xl shrink-0 border-4 border-surface-container-lowest shadow-sm overflow-hidden">
              {profile.avatar_url ? (
          ...
          {isEditing ? (
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="flex flex-col gap-1 sm:col-span-2">
                  ...
                  <textarea
                    ...
                    className="font-body-md text-on-surface bg-surface border border-outline-variant rounded-xl px-4 py-2 outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all min-h-[100px] resize-y"
                  />
                </div>
                <div className="flex flex-col gap-1">
            ...
            <div className="text-center md:text-left flex-1">
              ...
              {profile.bio && (
                <p className="text-on-surface-variant max-w-2xl mb-6 leading-relaxed whitespace-pre-wrap">
                  {profile.bio}
                </p>
              )}
