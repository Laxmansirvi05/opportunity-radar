...
import { CertificationsSection as CertificationsSectionData } from "@/features/resume-toolkit/lib/schema/resume/data";
import { SectionProps } from "../types";

export function CertificationsSection({ data }: SectionProps<CertificationsSectionData>) {
  if (data.hidden || !data.items || data.items.length === 0) return null;

  return (
    <section className="resume-section certifications-section flex flex-col gap-3">
