...
import { ProjectsSection as ProjectsSectionData } from "@/features/resume-toolkit/lib/schema/resume/data";
import { SectionProps } from "../types";

export function ProjectsSection({ data }: SectionProps<ProjectsSectionData>) {
  if (data.hidden || !data.items || data.items.length === 0) return null;

  return (
    <section className="resume-section projects-section flex flex-col gap-3">
