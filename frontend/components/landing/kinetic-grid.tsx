...
// LIGHT THEME
const LINE_BASE = { r: 15, g: 23, b: 42, a: 0.08 };
...
export default function KineticGrid({
    ...
    (now: number) => {
      ...
      const theme = {
        default: {
          // ONLY THEME CHANGED
          bg: "#FFFFFF",
          lineActive: { r: 37, g: 99, b: 235, a: 0.78 },
          nodeActive: { r: 37, g: 99, b: 235, a: 0.95 },
          glow: "37,99,235",
          ripple: "37,99,235",
        },
        ...
        monochrome: {
          // LIGHT MONOCHROME
          bg: "#FFFFFF",
          lineActive: { r: 15, g: 23, b: 42, a: 0.72 },
          nodeActive: { r: 15, g: 23, b: 42, a: 0.95 },
          glow: "15,23,42",
          ripple: "15,23,42",
        },
      }[globalColor ?? "default"];
      ...
      for (let row = 0; row < rows; row++) {
        for (let col = 0; col < cols; col++) {
          ...
          if (t > 0.3) {
            ...
            grd.addColorStop(
              0,
              `rgba(${theme.glow},${(t * 0.22).toFixed(3)})`,
            );
  ...
  useEffect(() => {
    ...
    const setSize = () => {
      ...
      // Make canvas 5% wider to cover the right side when shifted left by 5%
      const offset = w * 0.05;
  ...
  return (
    <div
      className={cn(
        "relative w-full min-h-screen overflow-x-clip bg-white",
        className,
      )}
    >
      <canvas
        ref={canvasRef}
        className="fixed top-0 -left-[5vw] w-[105vw] h-full z-0 pointer-events-none"
      />
