              ...
              <section className="scroll-mt-24" id="information-collected">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="p-4 bg-surface border border-outline-variant rounded-lg">
                    <h4 className="font-headline-sm text-headline-sm mb-1">Direct Submissions</h4>
                  ...
                  <div className="p-4 bg-surface border border-outline-variant rounded-lg">
                    <h4 className="font-headline-sm text-headline-sm mb-1">Automated Data</h4>
                  ...
                  <div className="p-4 bg-surface border border-outline-variant rounded-lg">
                    <h4 className="font-headline-sm text-headline-sm mb-1">Resume Storage</h4>
              ...
              <section className="scroll-mt-24" id="data-usage">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="p-6 bg-secondary-fixed text-on-secondary-fixed rounded-xl">
                    <h4 className="font-headline-sm text-headline-sm mb-2">Verification</h4>
                  ...
                  <div className="md:col-span-2 p-6 bg-surface rounded-xl border border-outline-variant">
                    <h4 className="font-headline-sm text-headline-sm mb-2">Product Improvement</h4>
