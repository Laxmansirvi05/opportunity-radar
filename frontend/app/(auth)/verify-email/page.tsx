  ...
  return (
    <div className="bg-surface text-on-surface min-h-screen flex flex-col">
      ...
      <main className="flex-grow flex items-center justify-center px-margin-mobile">
        <div className="max-w-[480px] w-full bg-surface-container-lowest border border-outline-variant hover:border-primary transition-colors duration-300 rounded-xl p-10 shadow-sm overflow-hidden relative">
          ...
          {!isVerified && (
            <div className="flex flex-col items-center text-center animate-in fade-in zoom-in duration-300">
              ...
              <h1 className="font-headline-lg text-headline-lg mb-2 text-on-surface">Check your inbox</h1>
              ...
              <div className="w-full space-y-4">
                <button
                  ...
                  className="w-full py-4 px-6 bg-primary text-on-primary font-label-md text-label-md rounded-lg hover:brightness-110 active:scale-[0.98] transition-all flex items-center justify-center gap-2 cursor-pointer"
                >
                  Resend Email
                </button>
                <button className="w-full py-4 px-6 border border-outline-variant bg-surface text-on-surface-variant font-label-md text-label-md rounded-lg hover:bg-surface-container-low active:scale-[0.98] transition-all cursor-pointer">
                  Change email
                </button>
              </div>
          ...
          {isVerified && (
            <div className="flex flex-col items-center text-center animate-in fade-in zoom-in duration-300">
              ...
              <h1 className="font-headline-lg text-headline-lg mb-2 text-on-surface">Email verified successfully</h1>
              <p className="font-body-md text-body-md text-on-surface-variant mb-10">
                Your account is now fully active. You&apos;re ready to explore high-impact career opportunities.
              </p>

              <div className="w-full">
                <Link href="/dashboard" className="w-full flex justify-center py-4 px-6 bg-primary text-on-primary font-label-md text-label-md rounded-lg hover:brightness-110 active:scale-[0.98] transition-all">
